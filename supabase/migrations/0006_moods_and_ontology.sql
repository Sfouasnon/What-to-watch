...
values
  ('edge-of-my-seat', 'Keep me on edge', 2.30, 1),
  ('make-me-laugh', 'Make me laugh', 2.15, 2),
  ('comfort-watch', 'Comfort watch', 2.82, 3),
  ('engage-me', 'Engage me', 2.60, 4),
  ('move-me', 'Move me', 2.29, 5),
  ('take-me-somewhere-else', 'Take me somewhere else', 1.75, 6),
  ('scare-me', 'Scare me', 3.42, 7),
  ('fall-in-love', 'Make me fall in love', 2.60, 8);
