-- Refresh the bounded publisher functions after PostgREST stopped exposing the
-- legacy request.jwt.claim.role setting. EXECUTE remains restricted to service_role.
